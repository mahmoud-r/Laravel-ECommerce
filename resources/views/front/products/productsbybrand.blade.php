                        ...
                        <div class="d-flex sort-by-row justify-content-end">
                            ...
                            <div class="products-sort-order dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a
                                        rel="nofollow"
                                        href="{{URL::current().'?sort=name_asc'}}"
                                    ...
                                    <a
                                        rel="nofollow"
                                        href="{{URL::current().'?sort=name_desc'}}"
                                        class="select-list  sort_by"
                                    >
                                    ...
                                    <a
                                        ...
                                        href="{{URL::current().'?sort=price_asc'}}"
                                        class="select-list sort_by"
                                    >
                                    ...
                                    <a
                                        rel="nofollow"
                                        href="{{URL::current().'?sort=price_desc'}}"
                                        class="select-list  sort_by"
                                    >
