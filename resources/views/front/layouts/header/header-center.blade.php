        ...
        <div class="row d-flex align-items-center">
            <div id="_desktop_logo" class="d-flex align-items-center justify-content-start col-lg-3 col-md-4">
                ...
                <div class="contentsticky_logo">
                    <a href="https://demo.bestprestashoptheme.com/savemart/">
                        <img class="logo img-fluid" src="/savemart/modules/novthemeconfig/images/logos/logo-2.png" alt="Prestashop_Savemart">
                    </a>
                </div>
                    ...
                    <nav id="nov-megamenu" class="clearfix">
                        ...
                        <div id="megamenu" class="nov-megamenu clearfix">
                            <ul class="menu level1"><li class="item home-page has-sub" ><span class="opener"></span><a href="?home" title="Home"><i class="zmdi zmdi-home"></i>Home</a><div class="dropdown-menu" style="width:200px"><ul class=""><li class="item " ><a href="?home=home_1" title="Homepage 1">Homepage 1</a></li>
                                ...
                                <li class="item  group" ><span class="opener"></span><a href="https://demo.bestprestashoptheme.com/savemart/en/2-home" title="Categories"><i class="zmdi zmdi-group"></i>Categories</a><div class="dropdown-menu" ><ul class=""><li class="item container group" ><div class="dropdown-menu" ><ul class=""><li class="item col-lg-3 col-md-3 html" ><span class="menu-title">Laptop</span><div class="menu-content"><ul class="col">
                ...
                <div class="advencesearch_header">
                    ...
                    <div id="_desktop_search" class="contentsticky_search">
                        ...
                        <div id="desktop_search_content"
                             ...
                             data-instantsearch=""
                             data-search_ssl="1"
                             data-link_search_ssl="https://demo.bestprestashoptheme.com/savemart/en/search"
                             data-action="https://demo.bestprestashoptheme.com/savemart/en/module/novadvancedsearch/result">
                            <form method="get" action="https://demo.bestprestashoptheme.com/savemart/en/module/novadvancedsearch/result" id="searchbox" class="form-novadvancedsearch">
                        ...
                        <div class="blockcart cart-preview active" data-refresh-url="//demo.bestprestashoptheme.com/savemart/en/module/ps_shoppingcart/ajax">
                            <div class="header-cart">
                                <div class="cart-left">
                                    ...
                                    <div class="cart-products-count">1</div>
                                </div>
                            ...
                            <div class="cart_block ">
                                <div class="cart-block-content">
                                    <ul>
                                        <li><div class="media">
                                                <img class="d-flex product-image" src="https://demo.bestprestashoptheme.com/savemart/29-cart_default/brown-bear-printed-sweater.jpg" alt="" title="">
                                                <div class="media-body">
                                                    ...
                                                    <a  class="remove-from-cart" rel="nofollow" href="https://demo.bestprestashoptheme.com/savemart/en/cart?delete=1&amp;id_product=2&amp;id_product_attribute=60&amp;token=28add935523ef131c8432825597b9928" data-link-action="remove-from-cart" title="remove from cart">
                                    ...
                                    <div class="cart-buttons d-flex">
                                        <a href="//demo.bestprestashoptheme.com/savemart/en/cart?action=show" class="btn btn-primary">View cart</a>
                                        <a href="https://demo.bestprestashoptheme.com/savemart/en/order" class="btn btn-primary">Checkout</a>
                                    </div>
                                </div>
                            </div>
                        </div>
